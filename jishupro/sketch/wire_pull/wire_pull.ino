...
const float angle_init_pose[10] = {
  //349.28, 279.32, 24.96, 147.57, 177.28, 289.95, 115.93, 4.13, 359.91, 60.47
  //350.07, 282.66, 19.07, 148.62, 205.22, 291.88, 119.53, 15.91, 359.91, 60.64
  //330.12, 248.73, 26.02, 185.63, 186.24, 242.49, 154.95, 0.00, 313.51, 44.03
  //334.25, 255.41, 18.54, 179.38, 186.24, 240.56, 150.12, 3.25, 313.07, 43.15
  // 359.91, 265.78, 16.87, 163.74, 174.55, 58.71, 140.80, 3.60, 326.25, 65.21  
  //359.91, 268.07, 14.15, 162.86, 174.99, 67.85, 140.54, 2.99, 325.02, 64.69 
  //359.91, 267.98, 15.12, 163.65, 174.29, 256.11, 140.36, 3.69, 326.25, 64.78
  // 359.91, 258.31, 13.18, 154.86, 181.58, 267.36, 151.44, 0.00, 302.78, 77.34 
  337.94, 266.75, 5.45, 166.20, 194.85, 270.44, 164.88, 359.91, 281.34, 83.58 
};
